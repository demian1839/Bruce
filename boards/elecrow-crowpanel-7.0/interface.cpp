...
// =============================================================================
//  CrowPanel 7.0" HMI (ESP32-S3) interface
//  - Display: RGB Panel over ESP32_RGB (handled by Arduino_GFX)
//  - Touch:   GT911 capacitive, directly on I2C (SDA=19, SCL=20, INT=-1),
//             no IO expander, no dedicated RST line.
//  - Backlight: direct PWM on GPIO2.
// =============================================================================
